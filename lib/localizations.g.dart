  ...
  static final Map<Locale, AppLocalizations_Labels> languages = {
    ...
    Locale.fromSubtags(languageCode: "pl"): AppLocalizations_Labels(
      auth: AppLocalizations_Labels_Auth(
        ...
        resetPasswordButton: "Wyślij Resetowanie hasła",
        emailFormField: "E-mail",
        passwordFormField: "Hasło",
        nameFormField: "Nazwa",
        signInErrorTitle: "Błąd logowania",
        signInError:
            "Logowanie nie powiodło się: e-mail lub hasło nieprawidłowe.",
        resetPasswordLabelButton: "Zapomniałeś hasła?",
        signUpLabelButton: "Utwórz konto",
        signUpErrorTitle: "Zapisz się powiodło.",
        signUpError:
            "Wystąpił problem podczas rejestracji. Spróbuj ponownie później.",
        signInLabelButton: "Mieć konto? Zaloguj się.",
        resetPasswordNoticeTitle: "Resetowanie hasła e-mail wysłany",
        resetPasswordNotice:
            "Sprawdź pocztę i postępuj zgodnie z instrukcjami, aby zresetować hasło.",
        resetPasswordFailed: "Resetowanie hasła Email nie powiodło się",
        signInonResetPasswordLabelButton: "Zaloguj się",
        updateUser: "Zaktualizować profil",
        updateUserSuccessNoticeTitle: "użytkownik Zaktualizowany",
        updateUserSuccessNotice:
            "Informacje o użytkowniku pomyślnie zaktualizowane.",
        updateUserFailNotice: "Nie udało się zaktualizować użytkownik",
        enterPassword: "Wprowadź hasło",
        cancel: "anulować",
        submit: "Zatwierdź",
        changePasswordLabelButton: "Zmień hasło",
        resetPasswordTitle: "Zresetuj hasło",
        updateProfileTitle: "Zaktualizować profil",
        wrongPasswordNoticeTitle: "logowanie nie powiodło się",
        wrongPasswordNotice: "Hasło nie pasuje do naszych danych.",
      ...
      app: AppLocalizations_Labels_App(
        title: "Trzepotanie Starter Projektu",
      ),
      validator: AppLocalizations_Labels_Validator(
        email: "Proszę wpisać aktualny adres e-mail.",
        password: "Hasło musi mieć co najmniej 6 znaków.",
        name: "Proszę podać nazwę.",
        number: "Proszę wpisać numer.",
        notEmpty: "To pole jest wymagane.",
        amount:
            "Proszę podać numer 250 - to znaczy nie symbol dolara i nie centów",
      ),
    ),
    ...
    Locale.fromSubtags(languageCode: "ru"): AppLocalizations_Labels(
      auth: AppLocalizations_Labels_Auth(
        ...
        wrongPasswordNoticeTitle: "Авторизация не удалась",
