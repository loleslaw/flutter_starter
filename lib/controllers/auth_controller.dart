import 'package:fb_template/helpers/helpers.dart';
...
class AuthController extends GetxController {
  ...
  signInWithEmailAndPassword(BuildContext context) async {
    ...
    zShowMessage(messageType: MessageType.ERROR, title: 'Sign in error', message: _em);
  }
  ...
  Future<void> sendPasswordResetEmail(BuildContext context) async {
    ...
    try {
      ...
      hideLoadingIndicator();
      zShowMessage(messageType: MessageType.MESSAGE,
      title: labels.auth.resetPasswordNoticeTitle, 
      message: labels.auth.resetPasswordNotice,
      );
